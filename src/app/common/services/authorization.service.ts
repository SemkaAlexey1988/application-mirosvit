...
getPhotos(){
          ...
          this.url = this.ApiService.getEventsUrl();
          return this.http.get(`${this.url}/${this.urlPhotos}`).pipe(map(response => {  
            return  response.json() 
          }));
            } 
...
getAdvantages(){
          this.url = this.ApiService.getEventsUrl();
          return this.http.get(`${this.url}/${this.urlAdvantages}`).pipe(map(response => {  
          return  response.json() 
              }));
                }           
