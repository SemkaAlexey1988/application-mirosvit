...
export class EventsService {
  ...
  urlEventsStatus:string = 'events-status';
...
getEventsStatus(id, userId, status){
  this.url = this.ApiService.getEventsUrl();
return this.http.get(`${this.url}/${this.urlEventsStatus}/${id}/${userId}/${status}`).pipe(map(response => { 
return  response.json() 
}));
}
